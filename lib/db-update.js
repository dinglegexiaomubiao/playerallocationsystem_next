...
const updateDatabaseStructure = async () => {
  ...
  try {
    ...
    await client.query(`ALTER TABLE public.tournaments ALTER COLUMN start_date TYPE DATE USING start_date::DATE;`);
    await client.query(`ALTER TABLE public.tournaments ALTER COLUMN end_date TYPE DATE USING end_date::DATE;`);
