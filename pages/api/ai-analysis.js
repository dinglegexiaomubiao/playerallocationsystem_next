...
1. 🦸 **英雄池与打法特征**：根据近期100场天梯比赛的英雄使用分布和胜率，分析该选手的英雄偏好类型（如先手控、刷核、游走等）、常用英雄之间的共性，尽量简短一些。
2. 🛠 **需要注意特殊英雄**: 注意一下对方最近100场天梯比赛中是否使用过一些特殊的英雄.
    强力或者恶心的:“修补匠”,“殁境神蚀者”，“哈斯卡”，“冥界亚龙”，"祈求者","大地之灵","天穹守望者","帕克","维萨吉","裂魂人","祸乱之源","司夜刺客","巨牙海民","谜团","瘟疫法师"
    需要特殊针对的优势路英雄:"变体精灵","幻影长矛手","恐怖利刃","米波","维萨吉","育母蜘蛛","娜迦海妖"如果有，要说明一下胜率和次数
3. 🤝 **作为队友如何BP**：该选手的英雄池适合搭配什么类型的英雄或体系，BP时帮他抢什么英雄能最大化其作用
4. 🎯 **作为对手如何针对**：该选手英雄池的薄弱环节在哪，BP时ban掉其核心英雄后他可能拿什么替代，替代英雄的效果预计如何
5. 📊 **数据特征**：近期GPM、KDA、伤害数据反映了怎样的打法风格（偏刷/偏打架/偏推进等），是否与其常用英雄类型吻合
...
1. 🎯 **阵容完整度**：5个位置覆盖情况，哪些位置存在重叠可以灵活换位置、哪些位置空缺
